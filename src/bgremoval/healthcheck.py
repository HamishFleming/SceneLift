...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run a startup healthcheck for a background-removal backend")
    parser.add_argument("--input", "-i", required=True, help="Input file path or camera spec like camera:0")
    parser.add_argument("--method", default="modnet-trt", help="Background-removal method to probe")
